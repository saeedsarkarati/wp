...
def form9():
	...
	def drawtext(x, y, s):
		painter.drawText(x - 150, y, 450, 100, Qt.AlignRight, s)
	...
	painter.setFont(font)
	drawtext(650, line['4'], "شهرستان:")
	drawtext(440, line['4'], "دشت:")
	drawtext(240, line['4'], "امور آب تابعه:")
	drawtext(650, line['5'], "نام منبع:")
	drawtext(440, line['5'], "شماره کلاسه پرونده:")
	drawtext(150, line['5'], "نوع مصرف:")
	...
	drawtext(650, line['8'], "نام:")
	drawtext(550, line['8'], "نام خانوداگی:")
	drawtext(350, line['8'], "نام پدر:")
	drawtext(150, line['8'], "شماره شناسنامه:")
	drawtext(650, line['9'], "شماره ملی:")
	drawtext(350, line['9'], "تلفن همراه:")
	drawtext(650, line['10'], "آدرس:")
	drawtext(650, line['11'], "شماره وکالت‌نامه:")
	drawtext(350, line['11'], "تاریخ ثبت وکالتنامه:")
	drawtext(150, line['11'], "شماره دفترخانه:")
	...
	drawtext(650, line['16'], "توضیحات:")
	drawtext(650, line['18'], "مقدار سهم‌آب سالیانه (شارژ سالیانه) در بانک:")
	drawtext(250, line['18'], "متر مکعب")
	drawtext(650, line['19'], "مقدار شارژ مورد نیاز جهت انتقال به کنتور یا جهت ارائه به رصدخانه")
